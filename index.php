...
<?php include 'header.php'; ?>
	...
	<div id="name-and-slogan">
		<h1>Birdview</h1>
		<h2>Urheilullista ilmakuvausta!</h2>
	</div>
	...
	<div id="main-content" class="container-fluid">
		...
		<div id="group-info" class="col-xs-12 col-sm-8 col-sm-offset-2 content-section" style="margin-top:70px;">
			<h1>Keitä ovat Birdview?</h1>

			<div class="member">
				<img src="images/anna_nermes.png">
				<h2>Anna Nermes</h2>
				<p>Opiskelen neljättä vuotta Aalto-yliopistossa, mutta toista vuotta informaatioverkostojen koulutusohjelmassa. Rakastan matkustaa ja matkalaukkuuni pakkaankin aina kameran tai kaksi. Kunpa saisin oman nelikopterikamerani!</p>
			</div>

			<div class="member">
				<img src="images/sakari_saarenpaa.png">
				<h2>Sakari Saarenpää</h2>
			...
			<div class="member">
				<img src="images/tuomas_antila.png">
				<h2>Tuomas Antila</h2>
				<p>blaa blaa blaa blaa blaa</p>
			</div>

			<div class="member">
				<img src="images/tuomas_kalliovaara.png">
				<h2>Tuomas Kalliovaara</h2>
				<p>Opiskelen kolmatta vuotta SCIssä, pääaineenani teknillinen fysiikka ja sivuaineenani systeemitieteet. Ulkoilma ja urheilu ovat lähellä sydäntäni.</p>
			</div>
		</div>
